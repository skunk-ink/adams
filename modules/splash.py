...
class splash():
    ...
    def print_splash(self):
        ...
        print(colours().green("\t               ") + colours().white("▄       ") + colours().green("███") + colours().white("───") + colours().green("███       ") + colours().white("▄               "))
        print(colours().green("\t              ") + colours().white("███     ") + colours().green("███") + colours().white("──") + colours().green("█") + colours().white("──") + colours().green("███     ") + colours().white("███              "))
        print(colours().green("\t               ") + colours().white("▀       ") + colours().green("██") + colours().white("──") + colours().green(colours().green("▄")) + colours().white("──") + colours().green("██       ") + colours().white("▀               "))
        print(colours().green("\t                         ") + colours().green("▀▀█▀▀                         "))
        print(colours().green("\t                ██                   ██                "))
        print(colours().green("\t                 ███               ███                 "))
